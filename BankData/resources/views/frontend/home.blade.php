...
<div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
    <div class="col-md-12 px-0">
        <h1 class="display-4 fst-italic">Welcome to Bank Data</h1>
        <p class="lead my-3">A repository of biotechnology information is a collection of data, information, and
            resources related to biotechnology. This can include scientific research papers, patents, and other
            technical documents, as well as educational materials and news articles about biotechnology. A
            repository of biotechnology information may be maintained by a government agency, a research
            organization, a university, or another entity. It can be accessed by the general public or by
            members of the biotechnology community, depending on the purpose and goals of the repository. A
            repository of biotechnology information can serve as a valuable resource for researchers, students,
            and others interested in learning more about the field and its applications.</p>
